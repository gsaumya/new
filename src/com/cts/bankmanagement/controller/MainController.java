...
public class MainController {
	...
	public ResponseEntity<?> addUser(UriComponentsBuilder b, @RequestBody UserVO userVO) {
		// UserVO userVO = new UserVO(100L, "saving", "Deepak Rana", 190909d);
		userService.addUserDetails(userVO);
		UriComponents uriComponents = b.path("/users/{0}").buildAndExpand(userVO.getAccountNumber());
	...
	public ModelAndView performTran(@RequestParam("accountHolderName") String accountHolderName,
	...
	public ModelAndView performSearch(@RequestParam("accountNumber") Long accountNo) {
